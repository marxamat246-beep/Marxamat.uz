        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px', height: '64px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontWeight: 800, fontSize: '16px', color: '#0f172a', letterSpacing: '-0.3px' }}>Marxamat.uz</span>
              <span style={{ fontSize: '9px', color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase' }}>Xo'jalik Mollari</span>
            </div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #be185d, #4c0519)', padding: '48px', borderRadius: '24px', color: 'white', minHeight: '320px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gridColumn: 'span 2' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '32px', flexWrap: 'wrap' }}>
              ...
              <a 
                href="https://t.me/marxamat_uzz" 
                target="_blank" 
                rel="noopener noreferrer" 
                style={{ color: 'white', fontWeight: 'bold', padding: '14px 28px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.3)', textDecoration: 'none', fontSize: '14px', display: 'inline-block', backgroundColor: 'rgba(255,255,255,0.1)' }}
              >
                Telegram
              </a>
            </div>
